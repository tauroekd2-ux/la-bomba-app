-- Normalizar telegram_chat_id al guardar: solo dígitos y opcional signo menos (formato que acepta la API de Telegram).
-- Así se evitan espacios o caracteres raros que impidan enviar el mensaje.

-- Función auxiliar: normalizar chat_id para Telegram (solo números y opcional -)
...
-- Actualizar consume_telegram_link_token para guardar chat_id normalizado
...
-- Actualizar link_telegram_by_token para guardar chat_id normalizado
...
-- Normalizar valores ya guardados en profiles (por si hay espacios o basura)
