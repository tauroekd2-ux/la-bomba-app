-- Un mismo telegram_chat_id solo puede estar en un usuario.
-- Al vincular, se quita ese chat_id de cualquier otro perfil; así no hay duplicados y el mensaje llega bien.
