-- RPC para borrar todas las confirmaciones y retiros visibles en Admin Phantom (empezar de cero).
-- Solo ejecutable por admin. Borra: confirmaciones_deposito, retiros_phantom y las filas de transacciones_phantom ligadas a retiros.
...
BEGIN
  ...
  -- Quitar FKs que apuntan a retiros_phantom (transacciones_phantom.retiro_id)
