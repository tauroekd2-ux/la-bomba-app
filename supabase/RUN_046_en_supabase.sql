...
-- Necesario para que el botón "Aprobar" del mensaje de retiro en Telegram funcione.
-- Requisito: en app_config debe existir key = 'telegram_webhook_secret' con el mismo valor que TELEGRAM_WEBHOOK_SECRET en tu .env (igual que para Rechazar).
